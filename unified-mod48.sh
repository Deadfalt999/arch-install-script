...
$PKG_DOSBOX_S    && _AUR_PKGS="$_AUR_PKGS dosbox-staging-bin"
...
$PKG_AZAHAR      && _AUR_PKGS="$_AUR_PKGS azahar-bin"
$PKG_SIMPLE64    && _AUR_PKGS="$_AUR_PKGS simple64-bin"
$PKG_RPCS3       && _AUR_PKGS="$_AUR_PKGS rpcs3-bin"
$PKG_DUCKSTATION && _AUR_PKGS="$_AUR_PKGS duckstation-bin"
...
# Installer les paquets AUR — --nocheck évite les tests LLVM (52835 tests = plusieurs heures)
su - '${USERNAME}' -c "${AUR_HELPER} -S --noconfirm --needed --nocheck ${_AUR_PKGS}"
AURSCRIPT
